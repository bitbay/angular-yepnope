...
hbo.GenericTool = angular.module('GenericTool', ['GenericTool.filters', 'GenericTool.services', 'GenericTool.directives']).
  config(['$routeProvider','yepnopeFactoryProvider',function($routeProvider,yepnopeFactory) {
    $routeProvider.when('/horizontal', {
    	templates: {
    		layout:	'partials/horizontal.html',
    		left:	'partials/foo.html',
    		right:	'partials/bar.html'
    	},
    	resolve: {
    		yepnopeLoader:	yepnopeFactory.$get()
    	},
    	dependencies: {
    		nope: {
